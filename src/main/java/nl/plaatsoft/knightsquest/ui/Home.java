...
import nl.plaatsoft.knightsquest.network.CloudVersion;
...
public class Home extends MyPanel {
  ...
  Home() {
    ...
    getChildren().add(new MyLabel(30, 20, AppConstants.APP_NAME + " v" + AppConstants.APP_VERSION, 30, "white", "-fx-font-weight: bold;"));
    getChildren().add(new MyLabel(30, 60, AppConstants.APP_BUILD, 20));
